    ...
    <body>
        <div class="container my-5">
            <div class="card mx-auto shadow-sm" style="max-width: 400px;">
                <div class="card-body">
                    <h4 class="text-center mb-4">Staff Register</h4>
                    <form method="POST" action="{{ route('staff.register') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="Phone" class="form-control" id="Phone" required placeholder="Enter your Phone">
                        </div>
                        <div class="mb-3">
                        ...
                        <div style="text-align: center; margin-top: 10px;">
                            If you already have an account <a href="{{ route('staff.login') }}">Click here</a>
                        </div>
                    </form>
                </div>
            </div>
